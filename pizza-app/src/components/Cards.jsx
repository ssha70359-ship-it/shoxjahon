...
import { ITEM_BY_ID, TOPPING_BY_ID, tr } from '../../shared/menu.js';
import { defaultPizzaConfig, describeLine, unitPrice } from '../../shared/pricing.js';
...
const TAG_ORDER = ['signature', 'new', 'hit', 'spicy', 'veg'];

export function Tags({ tags, t }) {
...
function PizzaCardImpl({ pizza, lang, t, soldOut, onOpen }) {
...
export function LineView({ config, qty, unit, lang, onOpen, children, by }) {
