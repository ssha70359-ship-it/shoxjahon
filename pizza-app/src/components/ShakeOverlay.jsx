...
import { PIZZAS, tr } from '../../shared/menu.js';
import { defaultPizzaConfig } from '../../shared/pricing.js';
import { formatMoney } from '../lib/format.js';
import { useShake } from '../lib/sensors.js';
import { useStore } from '../lib/store.jsx';
import { hapticNotify, hapticSelect, hideBackButton, setBackButton } from '../lib/telegram.js';
import Icon from './Icon.jsx';
import { PizzaStage } from './PizzaStage.jsx';

/** "Taqdir pitsasi": telefonni silkiting — ruletka tasodifiy pitsada to'xtaydi */
export default function ShakeOverlay({ onClose, onPick, canShake }) {
