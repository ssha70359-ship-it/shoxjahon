...
const index = (list) => Object.fromEntries(list.map((entry) => [entry.id, entry]));

export const SIZE_BY_ID = index(SIZES);
export const CRUST_BY_ID = index(CRUSTS);
export const SAUCE_BY_ID = index(SAUCES);
...
export function tr(value, lang = 'uz') {
